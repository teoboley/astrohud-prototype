        ...
        try
        {
            ...
            else
            {
                ...
                if (state.sb.Length > 1)
                {
                    ...
                    IMessage responseMsg = JsonUtility.FromJson<IMessage>(response); // I think this is what caused the crash
...
public class Message<T> : IMessage
{
    ...
    public Message(String type, T payload) : base(type)
    {
